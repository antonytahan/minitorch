...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        Returns:
            list of tuples of Variables and their derivatives
        """
        h = self.history
        ...
        # return tuple of variable and derivative
        # return [(a, b) for a, b in zip(h.inputs, derivative) if not a.is_constant()]
