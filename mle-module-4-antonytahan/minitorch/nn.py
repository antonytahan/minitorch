...
def tile(input: Tensor, kernel: Tuple[int, int]) -> Tuple[Tensor, int, int]:
    ...
    new_tensor = input.contiguous()
    new_tensor = new_tensor.view(batch, channel, new_height, kh, new_width, kw)
    new_tensor = new_tensor.permute(0, 1, 2, 4, 3, 5)
    new_tensor = new_tensor.contiguous()
    new_tensor = new_tensor.view(batch, channel, new_height, new_width, kh * kw)
...
def avgpool2d(input: Tensor, kernel: Tuple[int, int]) -> Tensor:
    ...
    batch, channel, height, width = input.shape
    # TODO: Implement for Task 4.3.
    pooled_tensor, new_height, new_width = tile(input, kernel)
    pooled_tensor = pooled_tensor.mean(4)
    pooled_tensor = pooled_tensor.view(batch, channel, new_height, new_width)
...
def logsoftmax(input: Tensor, dim: int) -> Tensor:
    ...
    """
    # TODO: Implement for Task 4.4.
    new_tensor = input.exp().sum(dim).log()
